...
- **Storage:** Local JSON file (`data/habit.json`) using `fs/promises`
...
- **Request Body:** `{"name": "Read Bible", "description": "Daily reading"}`
- **Response:** `201 Created` - `{"message": "Habit created successfully", "data": {"id": "c3d4e5f6-a1b2-4890-abcd-ef4434567890", "name": "Read Bible", "createdAt": "2026-07-01T00:00:00.000Z"}}`
...
- **Request Body (Optional):** `{"date": "2026-07-08"}`
- **Response:** `200 OK`
  ```json
  {
    "message": "Habit checked in successfully",
    "data": {
      "id": "a1b2c3d4-e5f6-4890-abcd-ef4434567890",
      "name": "Drink Water",
      "checkIns": ["2026-07-08"],
      "currentStreak": 1,
      "longestStreak": 1
